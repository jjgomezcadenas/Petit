...
"""
    make_tracks(hitsdf, event_id; max_distance_mm=10.0, energy_threshold_kev=0.0, diffusion=DiffusionParams())
...
function make_tracks(hitsdf::DataFrame, event_id::Int;
    ...
    make_tracks(event_data;
                ...
                diffusion=diffusion, method=method)
end


"""
    make_tracks(event_data; max_distance_mm=1.0, energy_threshold_kev=0.0, diffusion=DiffusionParams())
