...
# ╔═╡ 31969db1-752d-43db-92dc-48323558e9e5
begin
	p, results = plot_signal_eff_vs_bkg_rejection(bbr3df, xer3df;
	      column = :eB2,
	      cut_min = 0.0,
	      cut_max = 300.0,
	      ncuts = 100
...
# ╔═╡ 297d32e2-6a05-4868-81cc-355cc9a8a463
rocr5mm

# ╔═╡ 1cd73b55-4f5f-44a1-b7aa-760585a108b7
rocr8mm[1:20, :]

# ╔═╡ 3f40139b-88b7-4cb4-ac52-cc1a00d047c4
rocr10mm[1:20, :]
